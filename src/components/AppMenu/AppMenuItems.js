...
export const MenuProvicer = (props) => {
...
const AppMenu = (props) => {
  ...
  const active = activeMenu === key || activeMenu.startWith(key + "-");
    ...
    <li
      ...
      {(!item.to || item.items) && item.visible !== false ? (
        <a
          ...
          {item.items && (
            <i className="pi pi-fw pi-angle-down layout-submenu-toogler"></i>
          )}
          <Ripple />
        </a>
      ) : null}
